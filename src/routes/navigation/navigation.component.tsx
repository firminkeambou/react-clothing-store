...
import { ReactComponent as CrwnLogo } from '../../assets/crown.svg'; // custom SVG logo component, this allows us to use the SVG as a React component | for TypeScript  look at "src/custom.d.ts" and tsconfig.json ( line  "include": ["src","src/custom.d.ts"]) to see how the conversion in type Script was solved
    ...
    <Fragment>
      <NavigationContainer>
        ...
        <NavLinks>
          ...
          {
            /** If currentUser is not null, then the user is signed in, so we show the SIGN OUT link; ||||NB special: to={undefined as never} requirement for typeScript */
            currentUser ? (
              <NavLink
                as="span"
