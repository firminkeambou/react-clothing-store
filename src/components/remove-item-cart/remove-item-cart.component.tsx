import { RemoveItemContainer, RemoveItemIcon } from './remove-item-cart.styles'; // styles for the cart icon component
...
import { removeItemFromCart } from '../../redux/store/cart/cart.action'; // Importing the ToggleContext to
import { useDispatch } from 'react-redux';
import { useSelector } from 'react-redux';
import { selectCartItems } from '../../redux/store/cart/cart.selector';
import { ItemIdProps } from '../../utils/components-general-types/components.general.types';
const RemoveItemCart = ({ itemId }: ItemIdProps) => {
