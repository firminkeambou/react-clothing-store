...
import {
  ...
  EmptyMessage,
  CartItems,
} from './cart-dropdown.styles'; // Importing styled components for styling
import { setIsCartOpen } from '../../redux/store/cart/cart.action'; // Importing the ToggleContext to
import {
  selectCartItems,
  selectIsCartOpen,
